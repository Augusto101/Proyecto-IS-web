...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		...
    		<a href="view_food_items.php" class="list-group-item ">Ver alimentos</a>
    		<a href="add_food_items.php" class="list-group-item ">Agregar alimentos</a>
    		<a href="edit_food_items.php" class="list-group-item active">Editar alimentos</a>
...
<div class="col-xs-3">
  ...
  <div class="form-area" style="padding: 10px 10px 110px 10px; ">
    ...
    <div style="text-align: center;">
      <h3>Haga clic en el menú <br><br></h3>
    </div>
    <?php
...
<div class="col-md-6">
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> EDITE SUS ARTÍCULOS DE ALIMENTOS  AQUI </h3>
          ...
          <div class="form-group">
            <label for="username"><span class="text-danger" style="margin-right: 5px;">*</span> Nombre de la comida: </label>
            <input type="text" class="form-control" id="dname" name="dname" value=<?php echo $row1['name'];  ?> placeholder="Your Nombre de la comida" required="">
          </div>     

          <div class="form-group">
            <label for="username"><span class="text-danger" style="margin-right: 5px;">*</span> Precio Comida: </label>
            <input type="text" class="form-control" id="dprice" name="dprice" value=<?php echo $row1['price'];  ?> placeholder="Your Food Precio (INR)" required="">
          </div>

          <div class="form-group">
            <label for="username"><span class="text-danger" style="margin-right: 5px;">*</span> Descripcion Comida: </label>
