<html>
  ...
  <head>
    <title> Manager Signup | Sabores de mi Tierra </title>
  </head>
  ...
  <body>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hola Administrador, <br> Bienvenido a <span class="edit"> Sabores de mi Tierra </span></h1>
     <br>
   <p>Empiece creando su cuenta</p>
    </div>
    </div>
    ...
    <div class="container" style="margin-top: 4%; margin-bottom: 2%;">
      ...
      <div class="panel panel-primary">
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            <label for="address"><span class="text-danger" style="margin-right: 5px;">*</span> Direccion: </label>
            <div class="input-group">
       ...
       <label style="margin-left: 5px;"><a href="managerlogin.php">¿Tienes una cuenta? Accede.</a></label>
