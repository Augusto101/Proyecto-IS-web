...
<html>
  ...
  <head>
    <title> Guest Acceso | Sabores de mi Tierra </title>
  </head>
      ...
      <div class="panel panel-primary">
        ...
        <div class="row">
          <div class="form-group col-xs-4">
              <button class="btn btn-primary" name="submit" type="submit" value=" Acceso ">Enviar</button>
          </div>

        </div>
        
       <label style="margin-left: 5px;"><a href="customersignup.php">Crea una cuenta nueva.</a></label>
