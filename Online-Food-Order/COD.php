...
?>
        ...
        <div class="container">
          <div class="jumbotron">
            <h1 class="text-center" style="color: green;"><span class="glyphicon glyphicon-ok-circle"></span> Pedido realizado correctamente.</h1>
          </div>
        </div>
        <br>

<h2 class="text-center"> ¡Gracias por ordenar en Sabores de mi Tierra! El proceso del pedido está completo.</h2>
...
<h3 class="text-center"> <strong>Su número de orden:</strong> <span style="color: blue;"><?php echo "$number"; ?></span> </h3>
