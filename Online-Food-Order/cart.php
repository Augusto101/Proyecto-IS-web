...
<tr>
<th width="40%">Nombre de la comida</th>
<th width="10%">Cantidad</th>
<th width="20%">Detalles de precio</th>
...
<td>Q <?php echo $values["food_price"]; ?></td>
<td>Q <?php echo number_format($values["food_quantity"] * $values["food_price"], 2); ?></td>
...
<?php
  echo '<a href="cart.php?action=empty"><button class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Vaciar carrito</button></a>&nbsp;<a href="foodlist.php"><button class="btn btn-warning">Seguir comprando</button></a>&nbsp;<a href="payment.php"><button class="btn btn-success pull-right"><span class="glyphicon glyphicon-share-alt"></span> Pagar la cuenta</button></a>';
?>
</div>
...
if(empty($_SESSION["cart"]))
{
  ...
  <div class="container">
      <div class="jumbotron">
        <h1>tu carrito de compras</h1>
        <p>¡UPS! No podemos oler nada de comida aquí. Vuelve atras para <a href="foodlist.php">Ordenar ahora.</a></p>
