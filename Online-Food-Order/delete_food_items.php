...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		...
    		<a href="delete_food_items.php" class="list-group-item active">Eliminar alimentos</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> BORRAR TUS ALIMENTOS DE AQUI </h3>
...
if (mysqli_num_rows($result) > 0)
{
  ...
  <table class="table table-striped">
    <thead class="thead-dark">
      <tr>
        <th> # </th>
        <th> ID de alimento </th>
        <th> Nombre de la comida </th>
        <th> Precio </th>
        <th> Description </th>
        <th> ID de restaurante </th>
      </tr>
    </thead>
