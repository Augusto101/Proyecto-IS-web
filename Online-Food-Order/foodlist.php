...
<html>
  ...
  <head>
    <title> Explore | Food Sabores de mi Tierra </title>
  </head>
...
<div class="jumbotron">
  <div class="container text-center">
    <h1>Bienvenido a Sabores de mi Tierra</h1>      
...
<h5 class="text-danger">Q <?php echo $row["price"]; ?>/-</h5>
<h5 class="text-info">Cantidad: <input type="number" min="1" max="25" name="quantity" class="form-control" value="1" style="width: 60px;"> </h5>
<input type="hidden" name="hidden_name" value="<?php echo $row["name"]; ?>">
<input type="hidden" name="hidden_price" value="<?php echo $row["price"]; ?>">
<input type="hidden" name="hidden_RID" value="<?php echo $row["R_ID"]; ?>">
<input type="submit" name="add" style="margin-top:5px;" class="btn btn-success" value="Añadir al carrito">
</div>
</form>
...
else
{
  ...
  <div class="container">
    <div class="jumbotron">
      <center>
         <label style="margin-left: 5px;color: red;"> <h1>¡UPS! No hay comida disponible.</h1> </label>
        <p>¡Te quedarás con hambre ...!:P</p>
      </center>
