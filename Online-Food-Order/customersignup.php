<html>
<head>
    <title> Guest Signup | Sabores de mi Tierra </title>
  </head>
  ...
  <body>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hola invitado <br> Bienvenido a <span class="edit"> Sabores de mi Tierra </span></h1>
     <br>
   <p>Empiece creando su cuenta</p>
    ...
    <div class="container" style="margin-top: 4%; margin-bottom: 2%;">
      ...
      <div class="panel panel-primary">
       ...
       <label style="margin-left: 5px;"><a href="customerlogin.php">¿Tienes una cuenta? Accede.</a></label>
